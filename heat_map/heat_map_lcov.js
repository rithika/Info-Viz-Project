...
d3.cloudshapes1.heat_lcov = function module() {
    ...
    function exports(_selection) {
		...
		console.log("entered lcov");
           var column_num = d3.keys(data[0]).filter(function(key) { return key !== "lno"; });	// to get the column names for different age groups
 ...
 console.log(colorScale(0),colorScale(1));
          ...
          var testSuites = svg.selectAll(".testSuites")
              ...
              .enter().append("text")
                ...
                .attr("y", function(d, i) { return (i+1) * gridSize+15; })
                .attr("x", 0)
           ...
           var hm0 = svg.selectAll(".hm")
              .data(data)
              .enter().append("rect")
              .attr("x", function(d) { return (d.lno) * gridSize; })
